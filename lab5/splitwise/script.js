...
var contractAddress = '0x86E424Bbf9A8173f9630079008539Dba28e3a4d0' // FIXME: fill this in with your contract's address/hash
...
function add_IOU(creditor, amount) {
	...
	if(path) {
		...
		for(var i=0;i<path.length-1;i++){
			BlockchainSplitwise.__add_IOU(path[i],path[i+1],-minAmount);
		}
	}
	BlockchainSplitwise.add_IOU(creditor,amount-minAmount,{gas:1000000});
}
